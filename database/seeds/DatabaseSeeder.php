...
//        Menu::create(["parent_id" => "7", "name" => "编辑权限", "url" => "permission.edit", "description" => "编辑权限的页面", "is_hide" => 1]);
        ...
        Menu::create(["parent_id" => "18", "name" => "新建院校", "url" => "college.create", "description" => "新增毕业院校", "is_hide" => 1]);
...
class PermissionTableSeeder extends Seeder
{
    public function run()
    {
        ...
        Permission::create(["display_name" => "毕业校园", "name" => "college.index"]); // id:19
        Permission::create(["display_name" => "新建校园页面", "name" => "college.create"]);
        Permission::create(["display_name" => "新建校园信息", "name" => "college.store"]);
        Permission::create(["display_name" => "删除校园信息", "name" => "college.destroy"]);
        Permission::create(["display_name" => "编辑校园页面", "name" => "college.edit"]);
        Permission::create(["display_name" => "编辑校园信息", "name" => "college.update"]);

        Permission::create(["display_name" => "特长标签", "name" => "tag.index"]); // id:25
